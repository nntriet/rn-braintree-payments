...
export enum CardholderNameStatus {
  FIELD_DISABLED = 0,
  FIELD_OPTIONAL = 1,
  FIELD_REQUIRED = 2,
}
...
export interface PayPalOptions extends Options {
  amount?: number; // one-time checkout amount
  offerCredit?: boolean;
}
...
export type GetCardNonceOptions = GetCardNonceBaseOptions &
  GetCardNonceOptionsIOS &
  GetCardNonceOptionsAndroid;
